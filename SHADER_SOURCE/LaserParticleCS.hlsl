...
void main(uint3 DTid : SV_DispatchThreadID)
{
    ...
    if (ParticleBufferUAV[DTid.x].active == 0)
    {
        ...
        {            
            ...
            InitalizeParticleBufferUAV(DTid.x, worldPosition.xyz, float4(RotatedX, RotatedY, 0.f, 1.f), maxLifeTime, RandSpeed, 0.f);
        }
    }
    else  
    {
        ...
        else
        {
            ...
            ParticleBufferUAV[DTid.x].position.x += ParticleBufferUAV[DTid.x].gravityAcc.y * deltaTime;
        }
    }
}
